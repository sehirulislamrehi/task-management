        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-right">
                    ...
                    <li class="breadcrumb-item active">Assigned Thana</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<div class="content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <a class="btn btn-primary my-3 btn btn-outline-dark float-right" data-content="{{route('admin.user-module.user.thana.add.modal', $user->id)}}" data-target="#myModal" data-toggle="modal" style="cursor: pointer;">
...
<script>
    ...
    $(function() {
        $('#dataGrid').DataTable({
            ...
            pagination: 10,
            ajax: {
                url: "{{ route('admin.user-module.user.get.user.thana.data', $user->id) }}",
                data: function(data) {
                    data.service_center_id = null;
                }
            },
            order: [
                [0, 'Desc']
